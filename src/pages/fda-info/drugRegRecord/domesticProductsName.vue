        ...
        <el-dialog  :visible.sync="dialogVisible" :lock-scroll="false">
            ...
            <div class="dialog-con">
                ...
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                        <span class="titleBarName fl">批准文号备注：</span>
                    </h4>
                ...
                <div class="dialog-item">
                    ...
                    <p class="item-value"><span>{{dataDetails.staRemarks | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
...
<script type="es6">
    ...
    export default {
        ...
        methods:{
            getList(params){//列表
                api.Get('/cloudMap/fda/getDomesticProductsNameList',params).then((res)=>{
                    this.loading=false;
            ...
            showPopup(id){//模态框
                ...
                api.Get('/cloudMap/fda/getDomesticProductsNameDetails',{
                    entName:this.$router.currentRoute.params.entName,
                    dpnId: id
                }).then((res)=>{
