            ...
            <table class="court-table">
                ...
                <tbody>
                    <tr v-for="(item,index) in datalist" @click="showPopup(item.id)">
                        ...
                        <td>{{item.cnProductName | isValue }}</td>
                        <td>{{item.effectiveDate | isValue }}</td>
        ...
        <el-dialog  :visible.sync="dialogVisible" :lock-scroll="false">
            ...
            <div class="dialog-con">
                ...
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                        <span class="titleBarName fl">生产国（地区）：</span>
                    </h4>
                    <p class="item-value"><span>{{dataDetails.proCountry | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                        <span class="titleBarName fl">生产企业（中文）：</span>
                    </h4>
                    <p class="item-value"><span>{{dataDetails.chManufactEnt | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                        <span class="titleBarName fl">生产企业（英文）：</span>
                    </h4>
                    <p class="item-value"><span>{{dataDetails.enManufactEnt | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                ...
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                        <span class="titleBarName fl">在华申报责任单位：</span>
                    </h4>
                    <p class="item-value"><span>{{dataDetails.chReportUnit | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                        <span class="titleBarName fl">在华责任单位地址：</span>
                    </h4>
                    <p class="item-value"><span>{{dataDetails.chReportUnitAds | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
                    ...
                    <p class="item-value"><span>{{dataDetails.approvalNum | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
...
<script type="es6">
    ...
    export default {
        ...
        methods:{
            getList(params){//列表
                api.Get('/cloudMap/fda/getImportCosmeticsList',params).then((res)=>{
                    this.loading=false;
            ...
            showPopup(cosmeticsId){//模态框
                this.dialogVisible = true;
                api.Get('/cloudMap/fda/getImportCosmeticsDetails',{
                    entId:1,
                    entName:this.$router.currentRoute.params.entName,
