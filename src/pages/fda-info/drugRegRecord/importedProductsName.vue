        ...
        <el-dialog  :visible.sync="dialogVisible" :lock-scroll="false">
            ...
            <div class="dialog-con">
                ...
                <div class="dialog-item">
                    ...
                    <p class="item-value"><span>{{dataDetails.packApprovalNo | isValue}}</span></p>
                </div>
                <div class="dialog-item">
                    <h4 class="clearfix item-name">
                        <i class="fl"></i>
...
<script type="es6">
    ...
    export default {
        ...
        methods:{
            getList(params){//列表
                api.Get('/cloudMap/fda/getImportedProductsList',params).then((res)=>{
                    this.loading=false;
            ...
            showPopup(id){//模态框
                ...
                api.Get('/cloudMap/fda/getImportedProductsDetails',{
                    entName:this.$router.currentRoute.params.entName,
                    drugId: id
                }).then((res)=>{
