<template>
    <div class="content-wrap">
        ...
        <info-list :list="financeList" cMenu="金融监管信息"  :currentTitle="cItem" @getList="chageList"></info-list>
            ...
            chageList(txt){
                ...
                switch (txt){
                    case '银监会行政处罚':
                        ...
                        break
                    case '证监会行政处罚':
                        this.$router.push({name:'financcCsrc'})
                        break;
                    case '保监会行政处罚':
                        this.$router.push({name:'financeCirc'})
                        break
                }
            }
        },
